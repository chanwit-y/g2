...
<div class="p-5 grid grid-cols-2 md:grid-cols-3 gap-4">
	{#each images as image}
		<div class={`flex relative cursor-pointer transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-105 duration-300 ${animate}`} on:click={handleSelectImage}>
			<!-- <div
